...
import { r as reactExports, e as getAugmentedNamespace, b as requireReact, c as commonjsGlobal, j as jsxRuntimeExports, R as React$3 } from "../ssr.js";
import { r as reactDomExports, R as ReactDOM } from "./index-DJdchkJA.js";
import { a as _setPrototypeOf, P as PropTypes, _ as _objectWithoutPropertiesLoose$3 } from "./index-CbZhI6hK.js";
...
function NoopTransition({
  ...
  const combinedRef = (0, _useMergedRefs$2.default)(ref, children.ref);
...
function useRTGTransitionProps(_ref) {
  ...
  const mergedRef = (0, _useMergedRefs$1.default)(nodeRef, (0, _utils$1.getChildRef)(children));
...
const TransitionGroupContext = React$3.createContext(null);
...
var Transition = /* @__PURE__ */ function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return (
      ...
      /* @__PURE__ */ React$3.createElement(TransitionGroupContext.Provider, {
        value: null
      }, typeof children === "function" ? children(status, childProps) : React$3.cloneElement(React$3.Children.only(children), childProps))
    );
  };
  return Transition2;
}(React$3.Component);
...
const TransitionWrapper = /* @__PURE__ */ React$3.forwardRef(({
  onEnter,
  onEntering,
  onEntered,
  onExit,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Transition, {
    ...
    ) : /* @__PURE__ */ React$3.cloneElement(children, {
      ref: attachRef
    })
  });
});
