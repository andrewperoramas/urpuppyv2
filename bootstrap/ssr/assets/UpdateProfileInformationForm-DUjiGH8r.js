import { V, a as ae, j as jsxRuntimeExports, U as Ue } from "../ssr.js";
...
import { z as ze } from "./transition-ByPZl9i6.js";
import "util";
import "stream";
import "path";
import "http";
...
function UpdateProfileInformation({
  ...
  const { data, setData, patch, errors, processing, recentlySuccessful } = ae({
    name: user.full_name,
    email: user.email
  });
  const submit = (e) => {
