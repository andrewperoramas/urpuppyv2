import { j as jsxRuntimeExports, R as React, $ as $e, r as reactExports } from "../ssr.js";
import Banner from "./Banner-pJ5CPDgd.js";
...
import { P as PuppyCard, F as FavoriteButton, G as Gender } from "./Card-Cc0Fg7O7.js";
...
import { B as BreederCard } from "./BreederCard-CBYbo9ou.js";
...
const Slider = ({ children, slidesPerView = 1, autoplay = false }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    Swiper,
    {
      ...
      children: React.Children.map(children, (child, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(SwiperSlide, { children: child }, index))
    }
  ) });
};
...
function Adsense(_a) {
  ...
  return React.createElement("ins", Object.assign({ className: `adsbygoogle ${className}`, style, "data-ad-client": client, "data-ad-slot": slot, "data-ad-layout": layout, "data-ad-layout-key": layoutKey, "data-ad-format": format, "data-full-width-responsive": responsive, "data-adtest": adTest }, rest), children);
}
