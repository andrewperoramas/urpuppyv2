import { r as reactExports, R as React, j as jsxRuntimeExports } from "../ssr.js";
import { a as autoUpdate, b as arrow, c as computePosition, o as offset, f as flip, s as shift } from "./floating-ui.dom-D9vmQZx1.js";
...
const q = ({ forwardRef: t, id: l, className: i, classNameArrow: c, variant: u = "dark", anchorId: d, anchorSelect: p, place: v = "top", offset: m = 10, events: h2 = ["hover"], openOnClick: w2 = false, positionStrategy: b2 = "absolute", middlewares: S2, wrapper: g, delayShow: A2 = 0, delayHide: O2 = 0, float: T2 = false, hidden: x2 = false, noArrow: N2 = false, clickable: $2 = false, closeOnEsc: I = false, closeOnScroll: B = false, closeOnResize: q2 = false, openEvents: H2, closeEvents: M2, globalCloseEvents: W, imperativeModeOnly: P, style: V, position: F, afterShow: K, afterHide: U, disableTooltip: X, content: Y, contentWrapperRef: G, isOpen: Z, defaultIsOpen: J = false, setIsOpen: Q, activeAnchor: ee, setActiveAnchor: te, border: oe, opacity: le, arrowColor: re, role: ne = "tooltip" }) => {
  var ie;
  ...
  reactExports.useEffect(() => {
    ...
    const a = [], u2 = (e2) => {
      me && (null == e2 ? void 0 : e2.target) === ee || ze(e2);
    }, p2 = (e2) => {
      me && (null == e2 ? void 0 : e2.target) === ee && De();
    ...
    Object.entries(Re).forEach(([e2, t3]) => {
      t3 && (v2.includes(e2) ? a.push({ event: e2, listener: Ve }) : m2.includes(e2) && a.push({ event: e2, listener: u2 }));
  ...
  }, activeAnchor: ee, place: pe.place, isOpen: Boolean(ye && !x2 && Ue && Xe) })), ye && !x2 && Ue ? React.createElement(g, { id: l, role: ne, className: classNames("react-tooltip", z.tooltip, D.tooltip, D[u], i, `react-tooltip__place-${pe.place}`, z[Xe ? "show" : "closing"], Xe ? "react-tooltip__show" : "react-tooltip__closing", "fixed" === b2 && z.fixed, $2 && z.clickable), onTransitionEnd: (e) => {
    R(de), me || "opacity" !== e.propertyName || (he(false), be(null), null == U || U());
  }, style: { ...V, ...pe.tooltipStyles, opacity: void 0 !== le && Xe ? le : void 0 }, ref: ce }, Ue, React.createElement(g, { className: classNames("react-tooltip-arrow", z.arrow, D.arrow, c, N2 && z.noArrow), style: { ...pe.tooltipArrowStyles, background: re ? `linear-gradient(to right bottom, transparent 50%, ${re} 50%)` : void 0 }, ref: se })) : null;
}, H = ({ content: t }) => React.createElement("span", { dangerouslySetInnerHTML: { __html: t } }), M = React.forwardRef(({ id: t, anchorId: l, anchorSelect: n, content: i, html: c, render: a, className: u, classNameArrow: d, variant: p = "dark", place: v = "top", offset: m = 10, wrapper: f = "div", children: h2 = null, events: w2 = ["hover"], openOnClick: b2 = false, positionStrategy: S2 = "absolute", middlewares: g, delayShow: E2 = 0, delayHide: _2 = 0, float: O2 = false, hidden: k2 = false, noArrow: T2 = false, clickable: L2 = false, closeOnEsc: C2 = false, closeOnScroll: R2 = false, closeOnResize: x2 = false, openEvents: N2, closeEvents: $2, globalCloseEvents: I, imperativeModeOnly: B = false, style: z2, position: D2, isOpen: M2, defaultIsOpen: W = false, disableStyleInjection: P = false, border: V, opacity: F, arrowColor: K, setIsOpen: U, afterShow: X, afterHide: Y, disableTooltip: G, role: Z = "tooltip" }, J) => {
