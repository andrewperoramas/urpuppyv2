...
import PostCommentForm from "./PostCommentForm-CZNTandG.js";
import { F as FacebookShareButton$1, T as TwitterShareButton$1 } from "./index-BMb4Zh5A.js";
...
const Show = ({ post, comments, is_liked, is_unliked }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { navType: "secondary", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "puppy-spotlight py-7 py-md-5 py-xl-9", id: "scroll-target", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "d-flex  flex-row flex-sm-column flex-md-row  align-items-center justify-content-between  ", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "d-flex mb-8", style: {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card border mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-body", children: [
              ...
              user ? /* @__PURE__ */ jsxRuntimeExports.jsx(PostCommentForm, { post_id: post.id }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { href: "/register", children: "Signup to Comment" }),
