import { j as jsxRuntimeExports, U } from "../ssr.js";
...
const BannerSlider = ({ children, slidesPerView = 5 }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "banner-slider hero-section-inner-slider position-relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    Swiper,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "owl-carousel owl-theme position-relative", children: U.Children.map(children, (child, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(SwiperSlide, { className: "owl-item", children: child }, index)) })
    }
  ) });
};
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container position-relative z-2 pb-4 pb-lg-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-white fs-10 mb-3", children: title }),
