import { r as reactExports, V, j as jsxRuntimeExports, h as hr } from "../ssr.js";
...
const CheckoutV2Form = ({ clientSecret, plan_id }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (error) {
      ...
      hr.post("/checkout/complete", data, {
        onError: (errors) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { id: "payment-form", onSubmit: handleSubmit, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { href: "#", type: "button", children: "Checkout" }) }),
