import { r as reactExports, b as U } from "../ssr.js";
...
function processChildren(c) {
  const slides = [];
  U.Children.toArray(c).forEach((child) => {
...
function renderVirtual(swiper, slides, virtualData) {
  ...
  return slidesToRender.map((child, index) => {
    return /* @__PURE__ */ U.cloneElement(child, {
      swiper,
      style,
...
const Swiper2 = /* @__PURE__ */ reactExports.forwardRef(function(_temp, externalElRef) {
  ...
  return /* @__PURE__ */ U.createElement(Tag, _extends({
    ref: swiperElRef,
    className: uniqueClasses(`${containerClasses}${className ? ` ${className}` : ""}`)
  }, restProps), /* @__PURE__ */ U.createElement(SwiperContext.Provider, {
    value: swiperRef.current
  }, slots["container-start"], /* @__PURE__ */ U.createElement(WrapperTag, {
    className: wrapperClass(swiperParams.wrapperClass)
  }, slots["wrapper-start"], renderSlides(), slots["wrapper-end"]), needsNavigation(swiperParams) && /* @__PURE__ */ U.createElement(U.Fragment, null, /* @__PURE__ */ U.createElement("div", {
    ref: prevElRef,
    className: "swiper-button-prev"
  }), /* @__PURE__ */ U.createElement("div", {
    ref: nextElRef,
    className: "swiper-button-next"
  })), needsScrollbar(swiperParams) && /* @__PURE__ */ U.createElement("div", {
    ref: scrollbarElRef,
    className: "swiper-scrollbar"
  }), needsPagination(swiperParams) && /* @__PURE__ */ U.createElement("div", {
    ref: paginationElRef,
...
const SwiperSlide = /* @__PURE__ */ reactExports.forwardRef(function(_temp, externalRef) {
  ...
  return /* @__PURE__ */ U.createElement(Tag, _extends({
    ...
    onLoad: onLoad2
  }, rest), zoom && /* @__PURE__ */ U.createElement(SwiperSlideContext.Provider, {
    value: slideData
  }, /* @__PURE__ */ U.createElement("div", {
    className: "swiper-zoom-container",
    "data-swiper-zoom": typeof zoom === "number" ? zoom : void 0
  }, renderChildren(), lazy && !lazyLoaded && /* @__PURE__ */ U.createElement("div", {
    className: "swiper-lazy-preloader"
  }))), !zoom && /* @__PURE__ */ U.createElement(SwiperSlideContext.Provider, {
    value: slideData
  }, renderChildren(), lazy && !lazyLoaded && /* @__PURE__ */ U.createElement("div", {
    className: "swiper-lazy-preloader"
  })));
...
export {
  ...
  getWindow as f,
  getDocument as g,
  elementChildren as h,
  elementOffset as i,
  getTranslate as j,
  isObject$1 as k,
  elementTransitionEnd as l,
