...
import { M as Modal } from "./Modal-DT9juzQr.js";
...
import "./GenericModal-D9DGPbio.js";
...
function SavedSearchModal({ has_search }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: has_search == true && typeof window !== "undefined" && /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8 text-end", children: [
    user && ((_a = user.roles) == null ? void 0 : _a.includes("buyer")) && /* @__PURE__ */ jsxRuntimeExports.jsx("a", { onClick: handleShow, href: "#", className: "btn btn-outline-extralight border btn-white text-dark", "data-bs-toggle": "modal", "data-bs-target": "#SaveThisSearch", children: "Save This Search" }),
