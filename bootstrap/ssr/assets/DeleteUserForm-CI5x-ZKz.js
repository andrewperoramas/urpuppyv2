import { j as jsxRuntimeExports, r as reactExports, R as React, m as me } from "../ssr.js";
import { I as InputError } from "./InputError-BrGvvBAw.js";
import { I as InputLabel } from "./InputLabel-DAgP54zY.js";
import { s as s$2, K, L, o as o$2, y as y$3, n as n$2, a as o$3, b as s$3, u as u$3, t as t$2, T as T$1, l as l$2, p as p$2, f as f$6, O as O$3, c as u$4, i as i$2, d as s$4, z as ze, F as Fe } from "./transition-CRfSHJuS.js";
...
let S$2 = "p";
function C$1(r2, e2) {
  let d2 = reactExports.useId(), t2 = a$a(), { id: i2 = `headlessui-description-${d2}`, ...l2 } = r2, n2 = f$4(), s2 = y$3(e2);
  ...
  return L()({ ourProps: D2, theirProps: l2, slot: p2, defaultTag: S$2, name: n2.name || "Description" });
}
let _$1 = K(C$1), H$1 = Object.assign(_$1, {});
var o$1 = ((r2) => (r2.Space = " ", r2.Enter = "Enter", r2.Escape = "Escape", r2.Backspace = "Backspace", r2.Delete = "Delete", r2.ArrowLeft = "ArrowLeft", r2.ArrowUp = "ArrowUp", r2.ArrowRight = "ArrowRight", r2.ArrowDown = "ArrowDown", r2.Home = "Home", r2.End = "End", r2.PageUp = "PageUp", r2.PageDown = "PageDown", r2.Tab = "Tab", r2))(o$1 || {});
let e$1 = reactExports.createContext(() => {
});
function C({ value: t2, children: o2 }) {
  return React.createElement(e$1.Provider, { value: t2 }, o2);
}
...
var F = ((n2) => (n2[n2.First = 1] = "First", n2[n2.Previous = 2] = "Previous", n2[n2.Next = 4] = "Next", n2[n2.Last = 8] = "Last", n2[n2.WrapAround = 16] = "WrapAround", n2[n2.NoScroll = 32] = "NoScroll", n2[n2.AutoFocus = 64] = "AutoFocus", n2))(F || {}), T = ((o2) => (o2[o2.Error = 0] = "Error", o2[o2.Overflow = 1] = "Overflow", o2[o2.Success = 2] = "Success", o2[o2.Underflow = 3] = "Underflow", o2))(T || {}), y$1 = ((t2) => (t2[t2.Previous = -1] = "Previous", t2[t2.Next = 1] = "Next", t2))(y$1 || {});
...
function A(e2, r2 = 0) {
  var t2;
  return e2 === ((t2 = u$2(e2)) == null ? void 0 : t2.body) ? false : u$3(r2, { [0]() {
...
function n(...e2) {
  return reactExports.useMemo(() => u$2(...e2), [...e2]);
}
...
function l(o2) {
  return React.createElement(e.Provider, { value: o2.force }, o2.children);
}
function N(u2) {
  let r2 = a$3(), n$12 = reactExports.useContext(v), e2 = n(u2), [o2, l2] = reactExports.useState(() => {
    var t2;
    if (!r2 && n$12 !== null) return (t2 = n$12.current) != null ? t2 : null;
  ...
  }, [o2, e2]), reactExports.useEffect(() => {
    r2 || n$12 !== null && l2(n$12.current);
  }, [n$12, l2, r2]), o2;
}
let M = reactExports.Fragment, S = K(function(r2, n$12) {
  let e2 = r2, o2 = reactExports.useRef(null), l2 = y$3(T$1((i2) => {
    o2.current = i2;
  }), n$12), p2 = n(o2), a3 = N(o2), [t2] = reactExports.useState(() => {
    var i2;
    return s$2.isServer ? null : (i2 = p2 == null ? void 0 : p2.createElement("div")) != null ? i2 : null;
  }), s2 = reactExports.useContext(y), b2 = l$2();
  n$2(() => {
  ...
  let H2 = L();
  return b2 ? !a3 || !t2 ? null : reactDomExports.createPortal(H2({ ourProps: { ref: l2 }, theirProps: e2, slot: {}, defaultTag: M, name: "Portal" }), t2) : null;
});
function j(u2, r2) {
  let n2 = y$3(r2), { enabled: e2 = true, ...o2 } = u2, l2 = L();
  return e2 ? React.createElement(S, { ...o2, ref: n2 }) : l2({ ourProps: { ref: n2 }, theirProps: o2, slot: {}, defaultTag: M, name: "Portal" });
}
let W = reactExports.Fragment, v = reactExports.createContext(null);
function I$1(u2, r2) {
  let { target: n2, ...e2 } = u2, l2 = { ref: y$3(r2) }, p2 = L();
  return React.createElement(v.Provider, { value: n2 }, p2({ ourProps: l2, theirProps: e2, defaultTag: W, name: "Popover.Group" }));
}
let y = reactExports.createContext(null);
function te$1() {
  let u2 = reactExports.useContext(y), r2 = reactExports.useRef([]), n2 = o$2((l2) => (r2.current.push(l2), u2 && u2.register(l2), () => e2(l2))), e2 = o$2((l2) => {
    let p2 = r2.current.indexOf(l2);
    p2 !== -1 && r2.current.splice(p2, 1), u2 && u2.unregister(l2);
  }), o2 = reactExports.useMemo(() => ({ register: n2, unregister: e2, portals: r2 }), [n2, e2, r2]);
  return [r2, reactExports.useMemo(() => function({ children: p2 }) {
    return React.createElement(y.Provider, { value: o2 }, p2);
  }, [o2])];
}
let J = K(j), X = K(I$1), re$1 = Object.assign(J, { Group: X });
...
function O$1({ children: l2, node: n2 }) {
  ...
  return React.createElement(a$1.Provider, { value: u2 }, l2, u2 === null && React.createElement(f$5, { features: s$1.Hidden, ref: (t2) => {
    var i2, c2;
    if (t2) {
      for (let e2 of (c2 = (i2 = u$2(t2)) == null ? void 0 : i2.querySelectorAll("html > *, body > *")) != null ? c2 : []) if (e2 !== document.body && e2 !== document.head && e2 instanceof HTMLElement && e2 != null && e2.contains(t2)) {
        r2(e2);
        break;
      }
    }
...
function $(o2, e2) {
  let t2 = reactExports.useRef(null), r2 = y$3(t2, e2), { initialFocus: s2, initialFocusFallback: a$12, containers: n$12, features: u$12 = 15, ...f2 } = o2;
  l$2() || (u$12 = 0);
  let l2 = n(t2);
  ...
  let R2 = u(), g = o$2((c2) => {
    ...
    if (!m2) return;
    ((G) => G())(() => {
      u$3(R2.current, { [a2.Forwards]: () => {
        P(m2, F.First, { skipElements: [c2.relatedTarget, a$12] });
      }, [a2.Backwards]: () => {
        P(m2, F.Last, { skipElements: [c2.relatedTarget, a$12] });
      } });
    });
  }), v2 = x$1(!!(u$12 & 2), "focus-trap#tab-lock"), N2 = p$2(), F$1 = reactExports.useRef(false), k2 = { ref: r2, onKeyDown(c2) {
    c2.key == "Tab" && (F$1.current = true, N2.requestAnimationFrame(() => {
      F$1.current = false;
    }));
  }, onBlur(c2) {
    if (!(u$12 & 4)) return;
    ...
    d2 instanceof HTMLElement && d2.dataset.headlessuiFocusGuard !== "true" && (I(m2, d2) || (F$1.current ? P(t2.current, u$3(R2.current, { [a2.Forwards]: () => F.Next, [a2.Backwards]: () => F.Previous }) | F.WrapAround, { relativeTo: c2.target }) : c2.target instanceof HTMLElement && I$2(c2.target)));
  } }, B = L();
  return React.createElement(React.Fragment, null, v2 && React.createElement(f$5, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: g, features: s$1.Focusable }), B({ ourProps: k2, theirProps: f2, defaultTag: Z, name: "FocusTrap" }), v2 && React.createElement(f$5, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: g, features: s$1.Focusable }));
}
...
let V = K(function(t2, o2) {
  ...
  let T2 = reactExports.useRef(null), S2 = y$3(T2, o2), F2 = n(T2), g = i2 ? 0 : 1, [b$12, q] = reactExports.useReducer(Ie, { titleId: null, descriptionId: null, panelRef: reactExports.createRef() }), m2 = o$2(() => p2(false)), w2 = o$2((r2) => q({ type: 0, id: r2 })), D2 = l$2() ? g === 0 : false, [z, Q] = te$1(), Z2 = { get current() {
    var r2;
    return (r2 = b$12.panelRef.current) != null ? r2 : T2.current;
  } }, v2 = b(), { resolveContainers: I2 } = R({ mainTreeNode: v2, portals: z, defaultContainers: [Z2] }), B = c2 !== null ? (c2 & i$2.Closing) === i$2.Closing : false;
  y$2(u2 || B ? false : D2, { allowed: o$2(() => {
    var r2, H2;
  ...
  }), f$1(u2 || B ? false : D2, F2, I2), m$2(D2, T2, m2);
  let [ee2, te2] = w$2(), oe = reactExports.useMemo(() => [{ dialogState: g, close: m2, setTitleId: w2, unmount: P2 }, b$12], [g, b$12, m2, w2, P2]), U2 = reactExports.useMemo(() => ({ open: g === 0 }), [g]), ne = { ref: S2, id: l$12, role: s2, tabIndex: -1, "aria-modal": u2 ? void 0 : g === 0 ? true : void 0, "aria-labelledby": b$12.titleId, "aria-describedby": ee2, unmount: P2 }, re2 = !f(), y2 = x.None;
  D2 && !u2 && (y2 |= x.RestoreFocus, y2 |= x.TabLock, f$22 && (y2 |= x.AutoFocus), re2 && (y2 |= x.InitialFocus));
  let le = L();
  return React.createElement(s$4, null, React.createElement(l, { force: true }, React.createElement(re$1, null, React.createElement(k.Provider, { value: oe }, React.createElement(X, { target: T2 }, React.createElement(l, { force: false }, React.createElement(te2, { slot: U2 }, React.createElement(Q, null, React.createElement(ye, { initialFocus: d2, initialFocusFallback: T2, containers: I2, features: y2 }, React.createElement(C, { value: m2 }, le({ ourProps: ne, theirProps: h2, slot: U2, defaultTag: Me, features: Ge, visible: g === 0, name: "Dialog" })))))))))));
}), Me = "div", Ge = O$3.RenderStrategy | O$3.Static;
function ke(e2, t2) {
  let { transition: o2 = false, open: a3, ...l2 } = e2, i2 = u$4(), p2 = e2.hasOwnProperty("open") || i2 !== null, d2 = e2.hasOwnProperty("onClose");
  ...
  return (a3 !== void 0 || o2) && !l2.static ? React.createElement(O$1, null, React.createElement(ze, { show: a3, transition: o2, unmount: l2.unmount }, React.createElement(V, { ref: t2, ...l2 }))) : React.createElement(O$1, null, React.createElement(V, { ref: t2, open: a3, ...l2 }));
}
let we = "div";
function Be(e2, t2) {
  let o2 = reactExports.useId(), { id: a3 = `headlessui-dialog-panel-${o2}`, transition: l2 = false, ...i2 } = e2, [{ dialogState: p2, unmount: d2 }, s2] = O("Dialog.Panel"), f2 = y$3(t2, s2.panelRef), u2 = reactExports.useMemo(() => ({ open: p2 === 0 }), [p2]), P2 = o$2((S2) => {
    S2.stopPropagation();
...
let Ne = "h2";
function We(e2, t2) {
  let o2 = reactExports.useId(), { id: a3 = `headlessui-dialog-title-${o2}`, ...l2 } = e2, [{ dialogState: i2, setTitleId: p2 }] = O("Dialog.Title"), d2 = y$3(t2);
...
let $e = K(ke), je = K(Be);
K(He);
let Ye = K(We), yt = Object.assign($e, { Panel: je, Title: Ye, Description: H$1 });
function Modal({
  children,
  show = false,
  maxWidth = "2xl",
