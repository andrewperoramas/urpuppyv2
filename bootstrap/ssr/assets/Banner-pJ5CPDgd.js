import { c as commonjsGlobal, b as requireReact, K, R as React$1, j as jsxRuntimeExports, t as tt, r as reactExports, S as Sr } from "../ssr.js";
import { a as SelectFilterInput, M as MobilePicker, B as BreedFilter } from "./BreedFilter-BI8BPhcR.js";
import { G as GenericModal } from "./GenericModal-D9DGPbio.js";
import { S as StateFilter } from "./StateFilter-DoKCeVzJ.js";
import "util";
import "stream";
import "path";
import "http";
...
const PriceFilter = ({ setPrice, range = [1, 1e4] }) => {
  ...
  const [priceRange, setValues] = React$1.useState(price_filter_range);
