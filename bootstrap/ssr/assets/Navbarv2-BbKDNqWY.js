...
const AccountDropdownButton = ({ user }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dropdown position-relative user-profile-dropdown", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "btn btn-primary p-0 round-44 overflow-hidden rounded-circle d-flex align-items-center justify-content-center", href: "#", role: "button", "data-bs-toggle": "dropdown", "aria-expanded": "false", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: user.avatar, alt: "" }) }),
