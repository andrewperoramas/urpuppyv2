...
import { A as ApplicationLogo } from "./ApplicationLogo-BTI8O77G.js";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "navbar navbar-expand-xl py-0", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "collapse navbar-collapse justify-content-between", id: "menu-scroll", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "navbar-nav align-items-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "nav-item", children: /* @__PURE__ */ jsxRuntimeExports.jsx($e, { prefetch: true, cacheFor: "5m", className: "nav-link", href: "/puppies", children: "Puppies for Sale" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "nav-item", children: /* @__PURE__ */ jsxRuntimeExports.jsx($e, { prefetch: true, cacheFor: "5m", className: "nav-link ", href: "/breeds", children: "Breeds" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "nav-item", children: /* @__PURE__ */ jsxRuntimeExports.jsx($e, { className: "nav-link", href: "/breeders", children: "Breeders" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "nav-item", children: /* @__PURE__ */ jsxRuntimeExports.jsx($e, { prefetch: true, cacheFor: "5m", className: "nav-link active", "aria-current": "page", href: "/seller/create", children: "+ List Ur Puppy" }) })
        ] }),
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "offcanvas-body pt-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "navbar-nav", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "nav-item", children: /* @__PURE__ */ jsxRuntimeExports.jsx($e, { prefetch: true, cacheFor: "5m", className: "nav-link text-white", href: "/puppies", children: "Puppies for Sale" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "nav-item", children: /* @__PURE__ */ jsxRuntimeExports.jsx($e, { prefetch: true, cacheFor: "5m", className: "nav-link text-white", href: "/breeds", children: "Breeds" }) }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "nav-item", children: /* @__PURE__ */ jsxRuntimeExports.jsx($e, { prefetch: true, cacheFor: "5m", className: "nav-link text-white", href: "/seller/create", children: "+ List Ur Puppy" }) })
            ] }),
            !user && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "d-flex align-items-center flex-column gap-3 mt-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx($e, { preserveScroll: false, prefetch: true, cacheFor: "5m", className: "btn btn-white bg-white text-dark w-100", href: "/login", children: "Login" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs($e, { preserveScroll: false, prefetch: true, cacheFor: "5m", className: "btn btn-primary d-flex align-items-center justify-content-center gap-2 w-100", href: "/register", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/icon-user.svg", alt: "" }),
                " Sign Up"
              ] })
            ] })
