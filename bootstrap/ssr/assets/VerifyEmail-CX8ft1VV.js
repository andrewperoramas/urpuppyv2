...
import { G as Guest } from "./GuestLayout-DZwVJ62V.js";
import "util";
import "stream";
import "path";
import "http";
...
function VerifyEmail({ status, puppy }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Guest, { header: "Email Verification", puppy, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("form", { onSubmit: submit, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 d-flex justify-content-between", children: [
