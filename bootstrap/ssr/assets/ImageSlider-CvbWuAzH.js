...
import { m as makeElementsArray, c as createElementIfNotDefined, f as getWindow, h as elementChildren, d as elementParents, i as elementOffset, j as getTranslate, g as getDocument, k as isObject, n as now, l as elementTransitionEnd, S as Swiper, a as SwiperSlide } from "./create-element-if-not-defined-Lq8o-23T.js";
...
function Tree2Element(tree) {
  return tree && tree.map((node, i) => /* @__PURE__ */ U.createElement(node.tag, _objectSpread({
    key: i
...
const ImageSlider = ({
  ...
  reactExports.useEffect(() => {
    ...
    if (swiperRef.current) {
      (_b = (_a = swiperRef.current) == null ? void 0 : _a.swiper) == null ? void 0 : _b.update();
    }
  }, [images]);
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Swiper,
      {
        ...
        children: [
          ...
          videos && videos.length > 0 && videos.map((video, index) => video != "" && /* @__PURE__ */ jsxRuntimeExports.jsx(SwiperSlide, { className: " puppy-spotlight-img  position-relative overflow-hidden rounded-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "video",
            {
              controls: true,
              className: " w-100 h-100 object-fit-cover rounded-1 ",
    ...
    images.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
      Swiper,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
          ...
          images == null ? void 0 : images.map((file, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(SwiperSlide, { className: "thumbnail overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              className: " slide",
              src: file,
          ...
          videos && videos.length > 0 && videos.map((video, index) => video != "" && /* @__PURE__ */ jsxRuntimeExports.jsx(SwiperSlide, { className: "thumbnail overflow-hidden", style: {}, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              className: "slide",
              style: {
