    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "navbar navbar-expand-xl py-0", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "collapse navbar-collapse justify-content-between", id: "menu-scroll", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "navbar-nav align-items-center", children: [
          ...
          (((_b = user == null ? void 0 : user.roles) == null ? void 0 : _b.includes("seller")) || !user) && /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "nav-item", children: /* @__PURE__ */ jsxRuntimeExports.jsx($e, { prefetch: true, className: `nav-link ${page == "/seller/create" ? "active" : ""}`, "aria-current": "page", href: "/seller/create", children: "+ List Ur Puppy" }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "d-flex align-items-center gap-6", children: user ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ((_c = user == null ? void 0 : user.roles) == null ? void 0 : _c.includes("buyer")) && /* @__PURE__ */ jsxRuntimeExports.jsx($e, { className: "position-relative me-1", href: "/favorites", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/icon-heart-white.svg", alt: "" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(AccountDropdownButton, { user })
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "offcanvas-body pt-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "navbar-nav", children: [
              ...
              (((_d = user == null ? void 0 : user.roles) == null ? void 0 : _d.includes("seller")) || !user) && /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "nav-item", children: /* @__PURE__ */ jsxRuntimeExports.jsx($e, { prefetch: true, className: "nav-link text-white", href: "/seller/create", children: "+ List Ur Puppy" }) }),
