...
const PlanCard = ({ plan }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card subscription-plans-box border border-2 position-relative w-100", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-body", children: [
      ...
      plan.is_highlight ? /* @__PURE__ */ jsxRuntimeExports.jsx($e, { prefetch: true, className: "btn btn-primary w-100 mb-7", href: `/checkout/${plan.id}`, children: "Select plan" }) : /* @__PURE__ */ jsxRuntimeExports.jsx($e, { prefetch: true, className: "btn btn-outline-extralight border btn-white text-dark w-100 mb-7", href: `/checkout/${plan.id}`, children: "Select plan" }),
