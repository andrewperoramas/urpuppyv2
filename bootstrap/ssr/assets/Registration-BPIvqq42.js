import { j as jsxRuntimeExports, c as commonjsGlobal, V, a as ae } from "../ssr.js";
...
import { S as SemiHeading, a as StateCityDropdown, D as DateInput, b as SelectInput, Y as YesOrNoRadioInput, F as FileUpload } from "./StateCityDropdown-mITSC3vl.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dropdown", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        "aria-expanded": "false",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: icon, alt: "" })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "ul",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { onChange, type: "text", name: "ContactPerson", id: "ContactPerson", className: "form-control" })
      }
    )
  ] });
};
...
const SellerRegistrationForm = ({
  ...
  const patterns = V().props.patterns;
  const colors = V().props.colors;
  const siblings = V().props.siblings;
  const breeds = V().props.breeds;
  const puppy_count = V().props.puppy_count;
  const user = V().props.auth.user;
  const { patch, data, setData, post, errors } = ae({
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "contact-details border-bottom mb-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "row", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-lg-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(TextInput, { value: data.first_name })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-lg-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(InputLabel, { isRequired: true, value: "Last Name" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TextInput, { value: data.last_name })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-lg-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(InputLabel, { isRequired: true, value: "Email" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TextInput, { value: data.email })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-lg-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(InputLabel, { isRequired: true, value: "Phone" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TextInput, { type: "text", onChange: (e) => setData("phone", e.target.value) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "puppy-details border-bottom mb-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "row", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "col-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(InputLabel, { value: "About (Puppy Profile)", isRequired: true }),
