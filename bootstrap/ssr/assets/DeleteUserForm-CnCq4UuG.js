import { j as jsxRuntimeExports, r as reactExports, U as U$1, m as me } from "../ssr.js";
import { I as InputError } from "./InputError-BrGvvBAw.js";
import { I as InputLabel } from "./InputLabel-DAgP54zY.js";
import { s as s$2, K, L, o as o$2, y as y$3, n as n$2, a as o$3, b as s$3, u as u$3, t as t$2, T as T$1, l as l$2, p as p$2, f as f$6, O as O$3, c as u$4, i as i$2, d as s$4, z as ze, F as Fe } from "./transition-CleOffZr.js";
import { r as reactDomExports } from "./index-DAt-2Nmr.js";
...
function j(u2, r2) {
  ...
  return e2 ? U$1.createElement(S, { ...o2, ref: n2 }) : l2({ ourProps: { ref: n2 }, theirProps: o2, slot: {}, defaultTag: M, name: "Portal" });
}
let W = reactExports.Fragment, v = reactExports.createContext(null);
function I$1(u2, r2) {
  let { target: n2, ...e2 } = u2, l2 = { ref: y$3(r2) }, p2 = L();
  return U$1.createElement(v.Provider, { value: n2 }, p2({ ourProps: l2, theirProps: e2, defaultTag: W, name: "Popover.Group" }));
}
...
function te$1() {
  ...
  return [r2, reactExports.useMemo(() => function({ children: p2 }) {
    return U$1.createElement(y.Provider, { value: o2 }, p2);
  }, [o2])];
}
...
function $(o2, e2) {
  ...
  return U$1.createElement(U$1.Fragment, null, v2 && U$1.createElement(f$5, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: g, features: s$1.Focusable }), B({ ourProps: k2, theirProps: f2, defaultTag: Z, name: "FocusTrap" }), v2 && U$1.createElement(f$5, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: g, features: s$1.Focusable }));
}
...
let V = K(function(t2, o2) {
  ...
  let le = L();
  return U$1.createElement(s$4, null, U$1.createElement(l, { force: true }, U$1.createElement(re$1, null, U$1.createElement(k.Provider, { value: oe }, U$1.createElement(X, { target: T2 }, U$1.createElement(l, { force: false }, U$1.createElement(te2, { slot: U2 }, U$1.createElement(Q, null, U$1.createElement(ye, { initialFocus: d2, initialFocusFallback: T2, containers: I2, features: y2 }, U$1.createElement(C, { value: m2 }, le({ ourProps: ne, theirProps: h2, slot: U2, defaultTag: Me, features: Ge, visible: g === 0, name: "Dialog" })))))))))));
