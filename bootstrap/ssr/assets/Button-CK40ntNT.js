...
const Button = ({ type = "a", className, size = "md", variant, ...props }) => {
  return type == "button" ? /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: cn(buttonVariants({ variant, size }), className), ...props, children: props.children }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Ue, { href: props.href, as: type, className: cn(buttonVariants({ variant, size }), className), children: props.children });
};
