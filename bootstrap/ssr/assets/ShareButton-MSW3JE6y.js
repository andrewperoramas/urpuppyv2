...
function SocialMediaShareCount(_e) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", __spreadProps(__spreadValues({ className: y("react-share__ShareCount", className) }, rest), { children: !isLoading && count2 !== void 0 && children(count2) }));
}
