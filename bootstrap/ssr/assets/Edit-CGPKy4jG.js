import { j as jsxRuntimeExports, $ as $e, S as Sr, r as reactExports, b as requireReact, K } from "../ssr.js";
import { L as Layout } from "./Layout-Cm5pBenY.js";
import SubscriptionCard from "./SubscriptionCard-CWta36nw.js";
import UserProfile from "./UserProfile-BJoHSc74.js";
import MyPuppies from "./MyPuppies-Bi2K5k_x.js";
import { B as Button$2 } from "./Button-CgnQqdf2.js";
import { c as classNames } from "./index-St0ZXb81.js";
import { _ as _extends } from "./index-CVBuDtJP.js";
import { _ as _objectWithoutPropertiesLoose$2 } from "./index-CbZhI6hK.js";
import { u as useBootstrapPrefix, d as divWithClassName, a as useEventCallback, b as useCommittedRef, c as useIsomorphicEffect, e as useMounted, f as usePrevious, g as useEventCallback$1, C as CloseButton, F as Fade } from "./Modal-A4e15-Yc.js";
import "util";
import "stream";
import "path";
import "http";
...
function Edit({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    {
      navType: "secondary",
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "page-wrapper position-relative overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "account-settings py-7 py-md-5 py-xl-9", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container", children: [
            ...
            "ul",
            {
              ...
              children: NavigationSettings.map((item, index) => {
                ...
                if (item.name == "Saved Search") {
                  if (!((_a = user == null ? void 0 : user.roles) == null ? void 0 : _a.includes("buyer"))) {
                    return;
                  }
                }
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  !plan && !breeder_plan && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card-body pb-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "row", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h6", { className: "mb-4", children: "No Subscription" }) }) }) })
                ]
              }
            ) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
