          ...
          <div className="col-lg-8">
            <div className="row">
              <div className="col-md-4 mb-7 mb-md-0">
                <img src="../images/svgs/icon-reach-thousands-buyers.svg" alt="" />
              ...
              <div className="col-md-4 mb-7 mb-md-0">
                <img src="../images/svgs/icon-easy-to-use-tool.svg" alt="" />
              ...
              <div className="col-md-4">
                <img src="../images/svgs/icon-boosted-visibility.svg" alt="" />
