  ...
  return (
      ...
      <div className="container">
        <div className="d-flex align-items-center justify-content-between mb-4 mb-lg-8">
          ...
          <a className="btn btn-outline-extralight btn-white bg-white border text-dark d-none d-md-flex align-items-center gap-2"
            href="breeders.html" data-aos="fade-left" data-aos-delay="200" data-aos-duration="1000">Explore All
            Breeders</a>
        </div>
        <div className="row">
            {
        ...
        <a className="btn btn-outline-extralight btn-white bg-white border text-dark d-flex d-md-none align-items-center justify-content-center gap-2"
          href="breeders.html" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">Explore All Breeders</a>
      </div>
    </section>
    )
    }
