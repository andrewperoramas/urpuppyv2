                    ...
                    <a href="#"
                      className="btn btn-outline-primary d-flex align-items-center justify-content-center gap-2 mb-3 mb-xl-0"><svg
                        ...
                        <path
                          ...
                          stroke="#E88325" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round"></path>
                      </svg>View {breed.name} Puppies For Sale
                    </a>
                    <a className="btn btn-outline-extralight border btn-white text-dark d-flex align-items-center justify-content-center gap-2"
                      href="#">
                      <img className="w-auto" src="/images/svgs/icon-paws-dark.svg" alt="" width="15" height="15" />
                      View {breed.name} Breeders</a>
                  </div>
