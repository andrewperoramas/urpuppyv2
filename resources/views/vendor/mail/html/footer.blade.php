<tr>
  <td style="background-color: #FFF1DA; text-align: center;">
    ...
    <img src="https://wrappixelteam.github.io/urpuppy.com/assets/images/email-template/Simplification.png"
  ...
  <td style="background-color: #08314E; padding: 24px; text-align: center;">
    ...
    <div style="text-align: center; margin-top: 12px;">
      <a href="#"
        ...
        <img src="https://wrappixelteam.github.io/urpuppy.com/assets/images/email-template/tiktok.png"
          alt="tiktok" style="width: 20px; height: 20px; display: block; margin: 0;">
      </a>
      <a href="#"
        style="width: 44px; height: 44px; display: inline-flex; align-items: center; justify-content: center; color: white; background: #214660; border-radius: 100%; cursor: pointer; margin-left: 12px; text-align: center;">
        <img src="https://wrappixelteam.github.io/urpuppy.com/assets/images/email-template/facebook.png"
          alt="facebook" style="width: 20px; height: 20px; display: block; margin: 0;">
      </a>
      <a href="https://www.instagram.com/urpupppydotcom"
        style="width: 44px; height: 44px; display: inline-flex; align-items: center; justify-content: center; color: white; background: #214660; border-radius: 100%; cursor: pointer; margin-left: 12px; text-align: center;">
        <img src="https://wrappixelteam.github.io/urpuppy.com/assets/images/email-template/instagram.png"
          alt="instagram" style="width: 20px; height: 20px; display: block; margin: 0;">
      </a>
      <a href="https://x.com/UrpuppyDotCom"
        style="width: 44px; height: 44px; display: inline-flex; align-items: center; justify-content: center; color: white; background: #214660; border-radius: 100%; cursor: pointer; margin-left: 12px; text-align: center;">
        <img src="https://wrappixelteam.github.io/urpuppy.com/assets/images/email-template/twitter.png"
